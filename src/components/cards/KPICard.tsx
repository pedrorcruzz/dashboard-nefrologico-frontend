  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div
          className="w-10 h-10 bg-card-items/20 rounded-lg flex items-center justify-center"
          aria-hidden="true"
        >
      ...
      <div className="mb-2">
        <h3
          ...
          className="text-card-text text-sm font-medium mb-1"
        >
          {title}
        </h3>
        <div className="text-card-text text-2xl font-bold">{value}</div>
      </div>
