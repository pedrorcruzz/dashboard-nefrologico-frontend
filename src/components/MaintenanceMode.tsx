  ...
  return (
    ...
    >
      <div className="max-w-lg w-full text-center space-y-6">
        ...
        <div
          className="flex items-center justify-center gap-2 text-card-subtext"
          role="status"
          aria-live="polite"
        >
          <AiOutlineClockCircle className="w-5 h-5" aria-hidden="true" />
          <span className="text-sm">Voltaremos em breve</span>
        </div>

        <div
          className="bg-card-background/50 rounded-lg p-4 border border-card-line/40"
          role="region"
          aria-labelledby="maintenance-info"
        >
          <h2 id="maintenance-info" className="sr-only">
